...
<!-- Agregar el enlace a Font Awesome para el icono de la lupa -->
<head>
...
<div>
    ...
    <div id="filter-sidebar" class="filter-sidebar">
        ...
        <h2>Filtrar por Sede</h2>
        <select id="filtroSede" class="header-filter">
            <option value="">Filtrar</option>
            <!-- Las opciones se llenarán dinámicamente -->
        </select>
    </div>
    <button id="open-sidebar" class="open-sidebar">Filtrar</button>
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (openSidebar && closeSidebar && filterSidebar) {
